...
<div class="container-sm my-5">
    <form action="<?php echo e(route('resev.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" type="text" name="phone" id="phone" value="<?php echo e(old('phone')); ?>" placeholder="Enter Phone">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="date" id="resev_date" class="form-control <?php $__errorArgs = ['resev_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="resev_date" value="<?php echo e(old('resev_date')); ?>" placeholder="Enter Date">
                        <?php $__errorArgs = ['resev_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row">
                    <div class="col-md-6 d-grid">
                        <a href="<?php echo e(route('resev.index')); ?>" class="btn btn-outline-dark btn-lg mt-3"><i class="bi-arrow-left-circle me-2"></i>Cancel</a>
                    </div>
                    <div class="col-md-6 d-grid">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\framework\UAS\listFoody\resources\views/resev/create.blade.php ENDPATH**/ ?>