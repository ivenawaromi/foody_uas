    ...
    <div class="position-fixed px-4 pt-5 my-5 text-center border-bottom bg-white">
        ...
        <div class="col-lg-6 mx-auto">
            ...
            <div class="d-grid gap-2 d-sm-flex justify-content-sm-center mb-5">
                <a class="btn btn-lg px-4 me-sm-6" style="background-color: #fca838" href="<?php echo e(route('home')); ?>">See All</a>
            </div>
        </div>
        <div class="overflow-hidden" style="max-height: 50vh;">
            <div class="container px-5">
                <img src="<?php echo e(Vite::asset('resources/img/cover1.png')); ?>" class="img-fluid mb-4" alt="Example image" width="700" height="500" loading="lazy">
            </div>
        </div>
    </div>
...
<?php /**PATH C:\Users\ASUS\framework\UAS\listFoody\resources\views/welcome.blade.php ENDPATH**/ ?>