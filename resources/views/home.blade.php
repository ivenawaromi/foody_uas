...
<div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="{{ Vite::asset('resources/img/aptz6.jpg') }}" class="d-block img-fluid w-100" alt="appetizer">
        ...
        <div class="carousel-item">
            <img src="{{ Vite::asset('resources/img/sp2.jpg') }}" class="d-block img-fluid w-100" alt="soup">
            <div class="carousel-caption d-none d-md-block">
                <h5>Tom Yam</h5>
        ...
        <div class="carousel-item">
            <img src="{{ Vite::asset('resources/img/mc3.jpg')}}" class="d-img-fluid w-100" alt="Main Course">
            <div class="carousel-caption d-none d-md-block">
        ...
        <div class="carousel-item">
            <img src="{{ Vite::asset('resources/img/ds3.jpg')}}" class="d-block img-fluid w-100" alt="dessert">
            <div class="carousel-caption d-none d-md-block">
                <h5>Gelato</h5>
    ...
    <div class="row p-4 pb-0 pe-lg-0 pt-lg-5 align-items-center rounded-3 border shadow-lg">
        <div class="col-lg-7 p-3 p-lg-5 pt-lg-3">
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-start mb-4 mb-lg-3">
                <a href="{{ route('resev.create') }}" class="btn btn-md" style="background-color: #fca838">Reservation</a>
            </div>
        </div>
        <div class="col-lg-4 offset-lg-1 p-0 overflow-hidden">
            <img src="{{ Vite::asset('resources/img/cover1.png')}}" alt="cover home" class="rounded-lg-3" width="500">
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-md-5 mt-5">
        <img src="{{ Vite::asset('resources/img/logo.png')}}" class="img-thumbnail mt-4" alt="logo">
    </div>
