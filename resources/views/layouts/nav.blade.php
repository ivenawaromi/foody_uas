...
<nav class="navbar navbar-expand-md navbar-dark" style="background-color: #fca838">
    <div class="container">
        <a href="{{ route('home')}}" class="navbar-brand mb-0 h1"><i class="bi bi-basket2-fill me-2"></i>PalateParadise</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav flex-row flex-wrap">
                ...
                <li class="nav-item col-2 col-md-auto"><a href="{{ route('foods.index')}}" class="nav-link">Food List</a></li>
            </ul>
